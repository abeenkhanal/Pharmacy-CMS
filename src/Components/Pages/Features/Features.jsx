      ...
      <div className="w-full bg-white shadow-xl rounded-lg overflow-hidden p-8">
        ...
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6 rounded-lg mb-6">
          ...
          <p className="mt-2 text-sm">
            Edit the Key Features Section content below
          </p>
        </div>
        ...
        <div className="p-6">
          ...
          <form className="space-y-6">
            ...
            <div>
              ...
              <JoditEditor
                value=""
                onBlur={(content) => console.log(content)} // Logs updated content
                onChange={() => {}}
              />
            </div>
              ...
              <tbody>
                {features.map((feature) => (
                  ...
                  >
                    ...
                    <td className="p-4">{feature.title}</td>
                    <td className="p-4">{feature.description}</td>
