      ...
      const banners = [
        {
          ...
          description: "Discover a smarter way to manage your pharmacy. From inventory tracking to patient profiles, our software simplifies every aspect of your pharmacy operations.",
          image: "/about.jpg",
        },
    ];
        ...
        <div className="bg-gradient-to-br from-blue-50 to-gray-100 h-max  p-8">
            <div className="w-full bg-white shadow-xl rounded-lg overflow-hidden p-8">
                <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6 rounded-lg mb-6">
                    <h1 className="text-3xl font-bold">DISCOVER SECTION</h1>
