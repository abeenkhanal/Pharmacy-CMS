  ...
  const banners = [
    {
      ...
      subtitle: "Our comprehensive pharmacy management software helps streamline inventory, manage prescriptions, track sales, and enhance customer satisfaction. Simplify your pharmacy operations and focus on what matters most—providing quality care.",
      image: "/features.png",
    },
  ];
    ...
    <div className="bg-gradient-to-br from-blue-50 to-gray-100 h-max p-8">
      <div className="w-full bg-white shadow-xl rounded-lg overflow-hidden p-8">
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6 rounded-lg mb-6">
          ...
          <p className="mt-2 text-sm">Edit the discover section content below</p>
        </div>
