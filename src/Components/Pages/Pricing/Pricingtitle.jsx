  ...
  const banners = [
    {
      id: 1,
      title: "Pricing Plan", 
      subtitle: "Choose a plan that fits your pharmacy's needs.",
    },
  ];
    ...
    <div className="bg-gradient-to-br from-blue-50 to-gray-100 h-max p-8">
      <div className="w-full bg-white shadow-xl rounded-lg overflow-hidden p-8">
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6 rounded-lg mb-6">
          <h1 className="text-3xl font-bold">PRICE SECTION</h1>
          <p className="mt-2 text-sm">Edit the Price section content below</p>
        </div>
        ...
        <div className="bg-white w-11/12 mx-auto border rounded py-6 shadow-md">
          <h2 className="text-lg w-11/12 mx-auto font-medium mb-4">Manage Pricing</h2>
